...
export function PlayStoreIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M3.6 1.84a1.2 1.2 0 0 0-.35.85v18.62c0 .33.13.63.35.85l.06.06L14.1 11.8v-.24L3.66 1.78l-.06.06Z" opacity=".9" />
      <path d="m17.58 15.3-3.48-3.5v-.24l3.48-3.49.08.05 4.12 2.34c1.18.67 1.18 1.76 0 2.43l-4.12 2.34-.08.07Z" />
      <path d="M17.66 15.23 14.1 11.68 3.6 22.16c.39.41 1.03.46 1.75.05l12.31-6.98Z" opacity=".75" />
      <path d="M17.66 8.13 5.35 1.15C4.63.74 3.99.79 3.6 1.2l10.5 10.48 3.56-3.55Z" opacity=".6" />
    </svg>
  );
}
